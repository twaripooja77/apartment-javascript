          ...
          <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
              <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                <span class="fs-4">2BHK Apartment</span>
              </a>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
              ...
              <p class="fs-5 text-muted">Includes two bedrooms along with bathrooms, living room, kitchen and a balcony which might be divided by different walls.</p>
            </div>
          </header>
</div>
<main>
...
<?php
$select=mysqli_query($conn,"SELECT * FROM add2_apartment");
