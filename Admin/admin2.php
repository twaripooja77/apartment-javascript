...
if(empty($floor)||empty($roomno)||empty($roomsize)||empty($windowsize)||empty($balcony)||empty($rent)||empty($fileName)){
    ...
    $insert="INSERT INTO add2_apartment(floor,roomno,roomsize,windowsize,balcony,rent,image)
...
if(isset($_GET['delete'])){
    $id=$_GET['delete'];
    mysqli_query($conn,"DELETE FROM add2_apartment WHERE id=$id");
...
<tr>
    ...
    <td>
        <a href="admin2_update.php?edit=<?php echo $row['id'];?>" class="btn"><i class="fas fa-edit"></i>
    Edit</a>
    <a href="admin2.php?delete=<?php echo $row['id'];?>" class="btn"><i class="fas fa-trash"></i>
    Delete</a>
    </td>
