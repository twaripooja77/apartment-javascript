...
if(empty($floor)||empty($roomno)||empty($roomsize)||empty($windowsize)||empty($balcony)||empty($rent)||empty($fileName)){
    ...
    $insert="INSERT INTO add_apartment(floor,roomno,roomsize,windowsize,balcony,rent,image)
...
<tr>
    ...
    Edit</a>
    <a href="adminp.php?delete=<?php echo $row['id'];?>" class="btn"><i class="fas fa-trash"></i>
    Delete</a>
    </td>
