...
if(empty($floor)||empty($roomno)||empty($roomsize)||empty($windowsize)||empty($balcony)||empty($rent)||empty($fileName)){
    ...
    $update="UPDATE add1_apartment SET floor='$floor',roomno='$roomno',roomsize='$roomsize',windowsize='$windowsize',
...
<div class="list-group list-group-flush my-4">
    <a href="dashboard.php" class="list-gr0oup-item list-group-item-action bg-trasparent second-text active">
